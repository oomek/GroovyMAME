...
const options_entry osd_options::s_option_entries[] =
{
	...
	{ OSDOPTION_MISTER_INTERLACED_FB,            "1",              core_options::option_type::BOOLEAN,   "nogpu blit odd/even lines separately."},
...
void osd_common_t::register_options()
{
	...
	REGISTER_MODULE(m_mod_man, KEYBOARDINPUT_MISTER);
	...
	REGISTER_MODULE(m_mod_man, MOUSEINPUT_MISTER);
	...
	REGISTER_MODULE(m_mod_man, JOYSTICKINPUT_MISTER);

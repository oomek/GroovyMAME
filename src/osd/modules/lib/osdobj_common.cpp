...
// OS X can be trusted to have working hardware OpenGL, so default to it on for the best user experience
	...
	{ OSDOPTION_DOTCLOCK_MIN ";dcm",             "0",              core_options::option_type::STRING,    "Lowest pixel clock supported by video card, in MHz, default is 0" },
	{ OSDOPTION_SYNC_REFRESH_TOLERANCE ";srt",   "2.0",            core_options::option_type::STRING,    "Maximum refresh difference, in Hz, allowed in order to synchronize" },
